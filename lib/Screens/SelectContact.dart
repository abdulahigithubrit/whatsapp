...
import 'package:whatsappuntitled3/Screens/CreateGroup.dart';
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            ...
            ),), Text("256 contact",style: TextStyle(
              fontSize: 13,
            ),)
          ],
        ),
        actions: [
          IconButton(icon: Icon(Icons.search,size: 26,
              ...
              onPressed: (){}),    PopupMenuButton<String>(
            onSelected: (value) {
              print(value);
            },
            ...
            else if(index==1)
              {
                return InkWell(
                  onTap: (){
                    ...
                    child: ButtonCard(icon: Icons.person_add,name: "New contect",));
              }
