...
import 'package:whatsappuntitled3/CustomUl/OwnMessaeCrad.dart';

import '../CustomUl/ReplyCard.dart';
import '../Model/ChatModel.dart';
// // import 'package:flutter_svg/svg.dart';
// import 'package:socket_io_client/socket_io_client.dart' as IO;
// import 'package:socket_io_cli';
...
class _IndividualPageState extends State<IndividualPage> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        Image.asset("assets/whatasapp_Back.png",
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "last seen today at 12:05", style: TextStyle(fontSize: 13),)
                    ],
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: CircleAvatar(
                                radius: 25,
                                backgroundColor: Color(0xFF128C7),
                                child: IconButton(
        ...
        child: Column(
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
              iconCreation(Icons.insert_drive_file,Colors.indigo,"Decument"),
              SizedBox(width: 40,),
