...
import 'package:whatsappuntitled3/NewScreen/CountryPage.dart';
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              SizedBox(height: 15,),
              Text("welcome to whtasApp",style: TextStyle(
                color: Colors.teal,
                fontSize: 29,
              ...
              Padding(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: "Agreen Continue to  accept the",
                        style: TextStyle(
                ...
                child: Container(
                  ...
                  child: Card(
                    margin: EdgeInsets.all(0),
                      ...
                      child: Center(child: Text("AGREE AND CONTIME",
                      style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.w600,
                        fontSize: 16,
